...
$(function(){
    ...
    $('#form-request-demo').on('submit', function(event){
        
        event.preventDefault();

        let html = `<div class ='form-alert-success'>Request send successfully ! Thank you !</div>`;
        
        $('.request-form-response').html(html);

        $('#form-request-demo').trigger('reset');

        setTimeout(function(){
            $('.request-form-response').html('');
        }, 5000);
    ...
    $('#form-contact').on('submit', function(event){
        ...
        let html = `<div class ='form-alert-success'>Thank you for contacting us !</div>`;
    ...
    $('#form-support').on('submit', function(event){
        ...
        let html = `<div class ='form-alert-success'>Thank you ! Your request will be processed shortly ...</div>`;
        
        $('.support-form-response').html(html);

        $('#form-support').trigger('reset');

        setTimeout(function(){
            $('.support-form-response').html('');
        }, 5000);
